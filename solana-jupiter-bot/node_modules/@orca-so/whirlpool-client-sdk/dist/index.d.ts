...
declare function getWhirlpoolPda(programId: PublicKey, whirlpoolConfigKey: PublicKey, tokenMintAKey: PublicKey, tokenMintBKey: PublicKey, tickSpacing: number): PDA;
...
declare function getFeeTierPda(programId: PublicKey, whirlpoolsConfigAddress: PublicKey, tickSpacing: number): PDA;
...
declare function getStartTickIndex(tickIndex: number, tickSpacing: number): number;
