...
export declare const STAGING_TOKEN_LEDGER: PublicKey;
export declare const PRODUCTION_TOKEN_LEDGER: PublicKey;
...
export declare function createRiskCheckAndFeeInstruction(userDestinationTokenAccount: PublicKey, userTransferAuthority: PublicKey, minimumOutAmount: number, tokenLedger: PublicKey, platformFee: PlatformFee | undefined): TransactionInstruction;
