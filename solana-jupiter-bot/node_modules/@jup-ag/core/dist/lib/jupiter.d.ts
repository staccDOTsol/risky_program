...
export { AldrinAmm, CykuraAmm, RaydiumAmm, SerumAmm, SaberAmm, SplTokenSwapAmm, MercurialAmm, CropperAmm, SenchaAmm, SaberAddDecimalsAmm, SplitTradeAmm, WhirlpoolAmm, };
...
declare type JupiterLoadParams = {
...
export declare class Jupiter {
    ...
    computeRoutes({ inputMint, outputMint, inputAmount, slippage, feeBps, forceFetch, onlyDirectRoutes, filterTopNResult, }: {
        inputMint: PublicKey;
