...
export declare function tick2UiPrice(tick: number, baseDecimals: number, quoteDecimals: number): Decimal;
export declare function uiPrice2Tick(price: Decimal, baseDecimals: number, quoteDecimals: number): number;
export declare function lamportPrice2uiPrice(price: Decimal, baseDecimals: number, quoteDecimals: number): Decimal;
export declare function uiPrice2LamportPrice(price: Decimal, baseDecimals: number, quoteDecimals: number): Decimal;
