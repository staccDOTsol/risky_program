...
import { BN, parseIdlErrors, ProgramError, Program } from '@project-serum/anchor';
...
const getOrAddAssociatedTokenAccountTx = (associatedAddress, mintKey, provider, owner = FEE_OWNER_KEY) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return Token.createAssociatedTokenAccountInstruction(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, mintKey, associatedAddress, owner, 
    // @ts-ignore
...
const parseTransactionError = (error) => ProgramError.parse(error, idlErrors);
...
const findOpenOrdersForOptionMarkets = (program, serumProgramId, optionMarketKeys, priceCurrencyKey, optionMetaList) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    openOrdersInfos.forEach((info, index) => {
        ...
        openOrdersByOptionMarket[optionMarketKeys[index].toString()] =
            new OpenOrders(openOrdersKeys[index], OpenOrders.getLayout(serumProgramId).decode(info.data), serumProgramId);
    });
...
const deriveMarketAuthority = (program, dexProgramId, serumMarketKey) => __awaiter(void 0, void 0, void 0, function* () {
    return PublicKey.findProgramAddress([OPEN_ORDERS_INIT_SEED, dexProgramId.toBuffer(), serumMarketKey.toBuffer()], program.programId);
});
const deriveRequestQueue = (program, optionMarketKey, priceCurrencyKey) => PublicKey.findProgramAddress([
    optionMarketKey.toBuffer(),
    priceCurrencyKey.toBuffer(),
    textEncoder$1.encode("requestQueue"),
], program.programId);
const deriveCoinVault = (program, optionMarketKey, priceCurrencyKey) => PublicKey.findProgramAddress([
    optionMarketKey.toBuffer(),
    priceCurrencyKey.toBuffer(),
    textEncoder$1.encode("coinVault"),
], program.programId);
const derivePCVault = (program, optionMarketKey, priceCurrencyKey) => PublicKey.findProgramAddress([
    optionMarketKey.toBuffer(),
    priceCurrencyKey.toBuffer(),
...
const settleMarketFundsInstruction = (program, optionMarketKey, dexProgramId, serumMarket, baseWallet, quoteWallet, openOrdersKey) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const associatedAddress = yield Token.getAssociatedTokenAddress(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, serumMarket.quoteMintAddress, owner);
