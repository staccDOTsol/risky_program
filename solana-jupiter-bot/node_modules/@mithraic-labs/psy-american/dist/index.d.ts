import { PsyAmerican as PsyAmericanType } from "./psyAmericanTypes";
 ...
 * ````
 */
export declare const PsyAmericanIdl: PsyAmericanType;
export declare type PsyAmerican = PsyAmericanType;
