...
import { WhirlpoolData, PositionData, TickArrayData, WhirlpoolConfigAccount, TransactionBuilder, PDA, InitTickArrayParams } from '@orca-so/whirlpool-client-sdk';
...
declare class OrcaPool {
     ...
     * @returns
     */
    derivePDA(tokenMintA: Address, tokenMintB: Address, tickSpacing: number): PDA;
    /*** Transactions ***/
    /**
...
declare type EstimatedAprs = {
    fee: number;
    rewards: number[];
};
declare const ZERO_APR: {
    fee: number;
    rewards: number[];
};
declare function estimateAprsForPriceRange(pool: PoolData, tokenPrices: TokenUSDPrices, fees24h: number, tickLowerIndex: number, tickUpperIndex: number): EstimatedAprs;
...
declare function getNearestValidTickIndexFromTickIndex(tickIndex: number, tickSpacing: number): number;
declare function getNearestValidTickIndex(price: Decimal, decimalsA: number, decimalsB: number, tickSpacing: number): number;
declare function getNextValidTickIndex(tickIndex: number, tickSpacing: number): number;
declare function getPrevValidTickIndex(tickIndex: number, tickSpacing: number): number;
 ...
 * @returns
 */
declare function getStartTickIndex(tickIndex: number, tickSpacing: number, offset?: number): number;
...
declare type InternalRemoveLiquidityQuoteParam = {
...
declare function getRemoveLiquidityQuote(param: InternalRemoveLiquidityQuoteParam): RemoveLiquidityQuote;

declare const defaultSlippagePercentage: Percentage;
declare const ZERO_SLIPPAGE: Percentage;
...
export { AddLiquidityQuote, AddLiquidityQuoteParam, AddLiquidityTxParam, ClosePositionQuote, ClosePositionQuoteParam, ClosePositionTxParam, CollectFeesAndRewardsTxParam, CollectFeesQuote, CollectMultipleFeesAndRewardsTxParam, CollectProtocolFeesTxParam, CollectRewardsQuote, CombinedTokenPrice, DayWeekMonthData, DecimalUtil, EstimatedAprs, FillTickArraysParam, InitFeeTierConfigTxParam, InitPoolTxParam, InitRewardTxParam, InitWhirlpoolConfigsTxParam, InternalRemoveLiquidityQuoteParam, MinMax, MultiTransactionBuilder, OffchainPoolData, OffchainTokenData, OpenPositionQuote, OpenPositionQuoteByPrice, OpenPositionQuoteByTickIndex, OpenPositionQuoteParam, OpenPositionTxParam, OrcaNetwork, OrcaWhirlpoolClient, OrcaWhirlpoolClientConfig, Percentage, PoolData, PoolRewardInfo, PositionStatus, PositionUtil, RemoveLiquidityQuote, RemoveLiquidityQuoteParam, RemoveLiquidityTxParam, SetCollectProtocolFeesAuthorityTxParam, SetFeeAuthorityTxParam, SetFeeRateTxParam, SetProtocolFeeRateTxParam, SetRewardAuthorityBySuperAuthorityTxParam, SetRewardAuthorityTxParam, SetRewardEmissionsBySuperAuthorityTxParam, SetRewardEmissionsTxParam, SwapQuote, SwapQuoteParam$1 as SwapQuoteParam, SwapTxParam, TokenUSDPrices, UserPositionData, UserPositionRewardInfo, UserToken, ZERO_APR, ZERO_SLIPPAGE, adjustAmountForSlippage, adjustForSlippage, defaultNetwork, defaultSlippagePercentage, estimateAprsForPriceRange, getAmountFixedDelta, getAmountUnfixedDelta, getDefaultConnection, getDefaultOffchainDataURI, getDefaultSqrtPriceLimit, getInitFeeTierConfigTx, getInitWhirlpoolConfigsTx, getLiquidityFromTokenA, getLiquidityFromTokenB, getNearestValidTickIndex, getNearestValidTickIndexFromTickIndex, getNextSqrtPrice, getNextValidTickIndex, getPrevValidTickIndex, getRemoveLiquidityQuote, getStartTickIndex, getSwapQuote, getTickArrayPks, getTickArrayPublicKeysForSwap, getTokenAFromLiquidity, getTokenBFromLiquidity, isQuoteByPrice, isQuoteByTickIndex, priceToSqrtX64, priceToTickIndex, sqrtPriceX64ToPrice, tickIndexToPrice };
