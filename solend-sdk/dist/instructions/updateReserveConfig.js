...
///   6 `[]` Pyth price key.
///   7 `[]` Switchboard key.
const updateReserveConfig = (reserve, lendingMarket, lendingMarketAuthority, lendingMarketOwner, pythProduct, pythPrice, switchboardOracle, reserveConfig, solendProgramAddress) => {
