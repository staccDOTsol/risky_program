 ...
 */
export function calculateLiquity(tickLower, tickUpper, desiredAmountSrc, currentSqrtPrice, direct) {
    ...
    invariant(currentSqrtPrice.greaterThanOrEqualTo(lowerSqrtPrice) &&
 ...
 */
export function calculateTokenAmount(tickLower, tickUpper, liquity, currentSqrtPrice) {
    const lowerSqrtPrice = tick2SqrtPrice(tickLower);
    const upperSqrtPrice = tick2SqrtPrice(tickUpper);
 ...
 * @returns the liquity
 */
export function calculateLiquityOnlyA(tickLower, tickUpper, desiredAmountA) {
    invariant(tickLower < tickUpper, "The tickLower must less than tickUpper");
    const lowerSqrtPrice = tick2SqrtPrice(tickLower);
    const upperSqrtPrice = tick2SqrtPrice(tickUpper);
    const one = new Decimal(1);
 ...
 * @returns The liquity
 */
export function calculateLiquityOnlyB(tickLower, tickUpper, desiredAmountB) {
    invariant(tickLower < tickUpper, "The tickLower must less than tickUpper");
    const lowerSqrtPrice = tick2SqrtPrice(tickLower);
    const upperSqrtPrice = tick2SqrtPrice(tickUpper);
 ...
 */
export function calculateLiquityTable(ticks) {
 ...
 * @param liquity.
 */
export function calculateSlidTokenAmount(tickLower, tickUpper, liquity, currentSqrtPrice, slid) {
    invariant(slid.lessThan(1) && slid.greaterThan(0), `Invalid slid:${slid.toString()}`);
