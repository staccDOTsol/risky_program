...
const JupiterForm: FunctionComponent = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:space-x-6">
          ...
          <div className="rounded-lg border border-th-bkg-3 p-6">
            ...
            <div className="mt-2 grid grid-cols-2">
              <div className="col-span-1">
                <button
                  className="-ml-2 p-2 md:hover:bg-th-bkg-3"
            ...
            <div className="my-4 flex justify-center">
              <button onClick={handleSwitchMints}>
                <SwitchVerticalIcon className="default-transition h-8 w-8 rounded-full bg-th-bkg-4 p-1.5 text-th-fgd-1 md:hover:text-th-primary" />
              </button>
            </div>
            ...
            <div className="mt-2 grid grid-cols-2">
              <div className="col-span-1">
                <button
                  className="-ml-2 flex h-12 items-center p-2 md:hover:bg-th-bkg-3"
      ...
      <div className="w-full py-4 lg:w-2/3 lg:py-0">
        <Tabs activeTab={activeTab} onChange={handleTabChange} tabs={TABS} />
        {inputTokenInfo && outputTokenInfo && activeTab === 'Market Data' ? (
          <SwapTokenInfo
