  ...
  useEffect(() => {
    ...
    const fetchFundingStats = async () => {
      ...
      const response = await fetch(
        `https://mango-transaction-log.herokuapp.ca/v3/stats/total-funding?mango-account=${mangoAccountPk}`
      )
    ...
    const fetchHourlyFundingStats = async () => {
      ...
      const response = await fetch(
        `https://mango-transaction-log.herokuapp.ca/v3/stats/hourly-funding?mango-account=${mangoAccountPk}`
      )
      const parsedResponse = await response.json()
