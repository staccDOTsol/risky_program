  ...
  useEffect(() => {
    const fetchAccountActivity = async () => {
      ...
      try {
        const promises = [
          fetch(
            `https://mango-transaction-log.herokuapp.ca/v3/stats/activity-feed?mango-account=${mangoAccountPk}`
          ),
          fetch(
            `https://mango-transaction-log.herokuapp.ca/v3/stats/mango-account-lifetime-volumes?mango-account=${mangoAccountPk}`
          ),
        ]
