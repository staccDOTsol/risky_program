  ...
  useEffect(() => {
    ...
    const fetchInterestStats = async () => {
      ...
      const response = await fetch(
        `https://mango-transaction-log.herokuapp.ca/v3/stats/total-interest-earned?mango-account=${mangoAccountPk}`
      )
    ...
    const fetchHourlyInterestStats = async () => {
      ...
      const response = await fetch(
        `https://mango-transaction-log.herokuapp.ca/v3/stats/hourly-interest-prices?mango-account=${mangoAccountPk}`
      )
