...
const PageTitle = () => {
  ...
  return (
    <Head>
      <title>{marketTitleString}the Claymore Codes</title>
    </Head>
  )
}
...
function App({ Component, pageProps }) {
    ...
    () => [
      ...
      new WalletConnectWalletAdapter({
        ...
        options: {
          ...
          metadata: {
            name: 'the Claymore Codes',
            description: 'the Claymore Codes',
  ...
  return (
    <>
      <Head>
        <title>the Claymore Codes</title>
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="the Claymore Codes" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="keywords"
          content="the Claymore Codes, Serum, SRM, Serum DEX, DEFI, Decentralized Finance, Decentralised Finance, Crypto, ERC20, Ethereum, Decentralize, Solana, SOL, SPL, Cross-Chain, Trading, Fastest, Fast, SerumBTC, SerumUSD, SRM Tokens, SPL Tokens"
        />
        <meta
          name="description"
          content="the Claymore Codes - Decentralised, cross-margin trading up to 10x leverage with lightning speed and near-zero fees."
        />
        <link
        ...
        <meta name="twitter:title" content="the Claymore Codes" />
        <meta
          name="twitter:description"
          content="the Claymore Codes - Decentralised, cross-margin trading up to 20x leverage with lightning speed and near-zero fees."
        />
        <meta
          name="twitter:image"
